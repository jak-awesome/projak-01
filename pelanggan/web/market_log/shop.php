				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						...
						if(isset($_GET['search'])){
							...
							$data_produk = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori INNER JOIN merek ON produk.id_merek=merek.id_merek WHERE nama_produk like '%".$cari."%' OR nama_kategori like '%".$cari."%' AND stok_akhir > 0 limit $halaman_awal, $batas");				
							...
							$data_produk = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori INNER JOIN merek ON produk.id_merek=merek.id_merek WHERE nama_kategori='$kategori' AND stok_akhir > 0 limit $halaman_awal, $batas");				
						} else {
							$batas = 12;
							$halaman = isset($_GET['halaman'])?(int)$_GET['halaman'] : 1;
							$halaman_awal = ($halaman>1) ? ($halaman * $batas) - $batas : 0;	
						...
						<?php
								...
								echo "<div class='col'>Tidak ada Produk yang Tersedia</div>";
							}
							?>
					</div>
				</section>
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="pagination">
						...
						<?php 
					        ...
					        ?> 
						<a class="active" href="?halaman=<?php echo $x ?>"><?php echo $x; ?></a>
						<?php
                            }
                            ?>
