				...
				<div class="col-lg-12">
					...
					<div class="card  bg-white shadow p-5">
						<div class="mb-4 text-center">
							<svg xmlns="http://www.w3.org/2000/svg" class="text-info" width="75" height="75"
						...
						<div class="text-center">
							...
							<p>Silahkan transfer bukti pembayaran ke no. rekening BCA : <strong>9131241</strong><br>Lalu upload bukti pembayaran pada tombol upload dibawah</p>
							<form action="upload_bukti.php" method="post" enctype="multipart/form-data">
								...
								<div class="custom-file" style="width: 400px;">
									<input type="file" name="bukti_pembayaran" class="custom-file-input" id="customFile">
									<label class="custom-file-label" for="customFile">Choose file</label>
								</div><br><br>
								<input type="submit" name="proses" class="btn btn-outline-info" value="Send">
							</form>
						</div>
					</div>
				</div>
