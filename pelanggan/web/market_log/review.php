...
<body>
	...
	<section class="order_details section_gap">
		<div class="container">
			<h1>Ayo Beri Rating dan Review!</h1>
			<?php
			include "../../../koneksi.php";
			$id_pesanan = $_GET['id'];
			?>
			<div class="review_box">
				<h4>No. Invoice = <?= $id_pesanan ?></h4>
				<form class="row contact_form" action="add_review.php" method="post" id="contactForm" novalidate="novalidate">\
					<div class="col-md-12">
						<div class="form-group">
							<label>Nilai</label>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" class="form-check-input" value="1" name="skor">1 (Sangat Tidak Memuaskan)
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" class="form-check-input" value="2" name="skor">2 (Tidak Memuaskan)
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" class="form-check-input" value="3" name="skor">3 (Biasa Saja)
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" class="form-check-input" value="4" name="skor">4 (Memuaskan)
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" class="form-check-input" value="5" name="skor">5 (Sangat Memuaskan)
								</label>
							</div>
						</div>
					</div>
