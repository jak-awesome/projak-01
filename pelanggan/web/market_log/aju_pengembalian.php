				...
				<div class="col-lg-12">
					...
					<div class="card  bg-white shadow p-5">
						...
						<div class="text-center">
							...
							<p>Jika pesanan yang sampai tidak sesuai atau ada cacat dalam barang, anda bisa mengajukan pengembalian kepada kami<br>Proses pengajuan pengembalian membutuhkan waktu hingga 1x24 jam untuk proses peninjauan kepada kami<br>
								SIlahkan masukkan data dibawah untuk dilakukan peninjauan oleh kami</p>
							<form action="act_aju_pengembalian.php" method="post" enctype="multipart/form-data">
								<?php 
								include "../../../koneksi.php";
								$id_pesanan = $_GET['id'];
								?>
								...
								<label>Upload Bukti Cacat/Ketidaksesuaian</label><br>
								...
								<br>
								<input type="submit" name="proses" class="btn btn-outline-secondary" value="Send">
							</form>
						</div>
					</div>
				</div>
