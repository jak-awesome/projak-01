	...
	<section class="order_details section_gap">
		<div class="container">
			...
			while($data = mysqli_fetch_array($sql)){
				$sql_pengembalian = mysqli_query($koneksi, "SELECT * FROM pengembalian WHERE id_pesanan = '$id'");
				$data_pengembalian = mysqli_fetch_array($sql_pengembalian);
				if($data_pengembalian['status_pengembalian'] == "Pengembalian Dikonfirmasi"){
					$alert = "<div class='col-lg-12'>
									<div class='alert alert-info' role='alert'>
										<h4>Pengembalian Dikonfirmasi</h4>
										Silahkan kirim barang ke alamat ini <strong>Jl. Jend. Sudirman No.20, Kuningan, Kec. Kuningan, Kabupaten Kuningan, Jawa Barat 45511</strong>
									</div>
								</div>";
				} elseif($data_pengembalian['status_pengembalian'] == "Pengembalian Ditolak"){
					$alert = "<div class='col-lg-12'>
									<div class='alert alert-danger' role='alert'>
										<h4>Pengembalian Ditolak</h4>
										Pengembalian anda ditolak karena alasan atau bukti yang tidak kuat
									</div>
								</div>";
				} elseif($data_pengembalian['status_pengembalian'] == "Tahap Pengajuan") {
					$alert = "<div class='col-lg-12'>
									<div class='alert alert-primary' role='alert'>
										<h4>Tahap Pengajuan</h4>
										Silahkan tunggu untuk status selanjutnya
									</div>
								</div>";
				} elseif($data_pengembalian['status_pengembalian'] == "Dikirim") {
					$alert = "<div class='col-lg-12'>
				...
				} elseif($data_pengembalian['status_pengembalian'] == "Pengembalian Selesai") {
					$alert = "<div class='col-lg-12'>
								<div class='alert alert-success' role='alert'>
									<h4>Proses Pengembalian Selesai</h4>
									Barang masih dalam perjalanan
								</div>
							</div>";
				} else {
			...
			?>
				...
				<?php
					...
					} elseif($data_pengembalian['status_pengembalian'] == "Pengembalian Dikonfirmasi") {
						$tombol2 = "<a class='btn btn-primary' href='input_resi_pengembalian.php?id=$data[id_pesanan]' style='width: 100%;'>Input Resi</a>";
					} else {
						$tombol2 = "";
					}
				?>
