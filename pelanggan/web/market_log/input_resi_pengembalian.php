				...
				<div class="col-lg-12">
					...
					<div class="card  bg-white shadow p-5">
						...
						<div class="text-center">
							<h1>Input No. Rekening dan Resi Pengembalian (Return)</h1>
							<p>Silahkan inputkan no.rekening anda, nama ekspedisi yang digunakan dan resi pengirimannya dibawah </p>
							<form action="act_input_resi_pengembalian.php" method="post" enctype="multipart/form-data">
								<?php 
								include "../../../koneksi.php";
								$id_pesanan = $_GET['id'];
								?>
								...
								<div class="form-group" style="width: 400px;">
									...
									<input type="text" class="form-control" name="rekening" placeholder="Masukkan no. rekening anda disini...">
								</div>
								<div class="form-group" style="width: 400px;">
									<label>Ekspedisi</label>
									<input type="text" class="form-control" name="ekspedisi" placeholder="Masukkan nama ekspedisi disini...">
								</div>
								<div class="form-group" style="width: 400px;">
									<label>Resi</label>
									<input type="text" class="form-control" name="resi" placeholder="Masukkan resi disini...">
								</div></center>
								<input type="hidden" value="<?= $id_pesanan; ?>" name="id_pesanan">
								<input type="submit" name="proses" class="btn btn-outline-primary" value="Send">
							</form>
						</div>
					</div>
				</div>
