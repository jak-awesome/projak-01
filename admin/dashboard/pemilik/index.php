...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <marquee loop="1" >Selamat datang di Dashboard E-Commerce Alvindo Computama! Untuk informasi penggunaan, silahkan lihat di halaman <strong>Manual</strong> </marquee>
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <?php
                                                    ...
                                                    $jumlah_merek = mysqli_num_rows($query_merek);
                                                ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_merek; ?></div>
                                        </div>
                                        <div class="col-auto">
