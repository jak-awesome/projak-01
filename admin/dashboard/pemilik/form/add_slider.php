...
<div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Slider</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                    <form action="../actions/slider/act_add_slider.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nama Slider</label>
                                            <input type="text" class="form-control" name="nama" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Input File Gambar</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="exampleInputFile" name="gambar_slider" required>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch custom-switch-on-success">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch" value="yes" name="status">
    ...
    <?php if(@$_SESSION['gagal_tambah_slider']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_tambah_slider']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_tambah_slider']); } ?>
