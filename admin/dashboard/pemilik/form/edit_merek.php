...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Merek</h1>

                        <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    <a href="../data_merek.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                    <form action="../actions/merek/act_edit_merek.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nama Kategori</label>
                                                <input type="hidden" name="id_merek" value="<?php echo $data['id_merek']; ?>" class="form-control">
                                                <input type="text" name="nama_merek" value="<?php echo $data['nama_merek']; ?>" class="form-control">
                                        </div>
                                    </div>
    ...
    <?php if(@$_SESSION['gagal_edit_merek']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_edit_merek']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_edit_merek']); } ?>
