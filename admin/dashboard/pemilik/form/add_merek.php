...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Merek</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                    <form action="../actions/merek/act_add_merek.php" method="post" enctype="multipart/form-data">
    ...
    <?php if(@$_SESSION['gagal_tambah_merek']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_tambah_merek']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_tambah_merek']); } ?>
