...
<div id="content">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Produk</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                    <form action="../actions/produk/act_add_produk.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>ID Produk</label>
                                            <input type="text" class="form-control" name="id_produk" value="<?php echo $kodeProduk; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputFile">Input File Foto Produk</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="exampleInputFile" name="foto_produk" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summernote" name="detail" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Merek</label>
                                            <select name="nama_merek" class="form-control">
                                                ...
                                                <?php 
                                                   include "../../../../koneksi.php";
                                                   $sql1 = mysqli_query($koneksi, "SELECT * FROM merek");
                                                   while ($data1 = mysqli_fetch_array($sql1)) {
                                                ?>
                                                <option value="<?=$data1['id_merek']?>"><?=$data1['nama_merek']?></option> 
                                                <?php
                                                    }
                                                ?>
                                            </select>
    ...
    <script src="../vendor/jquery-autocomplete/dist/jquery.autocomplete.min.js"></script>
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                ...
                $( "#nama_kategori" ).autocomplete({
                    serviceUrl: "autocomplete_kategori.php",   // Kode php untuk prosesing data.
                    dataType: "JSON",           // Tipe data JSON.
                    onSelect: function (suggestion) {
                        $( "#nama_kategori" ).val("" + suggestion.nama_kategori);
                    }
                });
            })
        </script>
    ...
    <?php if(@$_SESSION['gagal_tambah_produk']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_tambah_produk']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_tambah_produk']); } ?>
