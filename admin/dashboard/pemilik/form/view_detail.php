...
<head>
    ...
    <title>View Detail Produk</title>
...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">View Deskripsi Produk</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            include "../../../../koneksi.php";
                                            $id = $_GET['id'];
                                            $query = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori
                                             INNER JOIN merek ON produk.id_merek=merek.id_merek WHERE id_produk = '$id'");
                                            while($data = mysqli_fetch_array($query)){
                                        ?>
                                        <div class="row">
                                            <div class="col-4">
                                                <img src="../images/produk/<?php echo $data['foto_produk']; ?>" width="400px" height="400px" style="object-fit: cover; border-radius: 25px;">
                                                <hr>
                                                <h4 class="text-center"><strong><?php echo $data['nama_produk']; ?></strong></h4>
                                            </div>
                                            <div class="col-8" >
                                                <h2 class="text-center"><strong>Deskirpsi Produk</strong></h2>
                                                <hr>
