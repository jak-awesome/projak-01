...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Slider</h1>

                        <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    <a href="../data_slider.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                    <form action="../actions/slider/act_edit_slider.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Nama Slider</label>
                                            <input type="hidden" class="form-control" name="id_slider" value="<?php echo $data['id_slider']; ?>">
                                            <input type="text" class="form-control" name="nama" value="<?php echo $data['judul']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Input File Gambar</label><br>
                                            <a href="../images/slider/<?php echo $data['gambar_slider']; ?>" target="_blank"><img src="../images/slider/<?php echo $data['gambar_slider']; ?>" width="auto" height="100px"></a><br>
                                            <input type="checkbox" name="ubah_gambar" class="form_control" value="true"> Ceklis jika ingin mengubah gambar<br><br>
                                        ...
                                        <?php
                                            ...
                                            <div class="custom-control custom-switch custom-switch-on-success">
                                                <input type="checkbox" class="custom-control-input" id="customSwitch" value="yes" name="status" <?php echo $status ?>>
                                                <label class="custom-control-label" for="customSwitch">Opsi untuk Matikan/Nyalakan</label>
                                            </div>
                                        </div>
    ...
    <?php if(@$_SESSION['gagal_ekstensi_slider']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_ekstensi_slider']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_ekstensi_slider']); } ?>

    <?php if(@$_SESSION['gagal_edit_slider']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_edit_slider']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_edit_slider']); } ?>

    <?php if(@$_SESSION['gagal_ukuran_slider']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_ukuran_slider']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_ukuran_slider']); } ?>
