                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Produk</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../data_produk.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            include "../../../../koneksi.php";
                                            $id = $_GET['id'];
                                            $query = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori INNER JOIN merek ON produk.id_merek=merek.id_merek WHERE id_produk = '$id'");
                                            while($data = mysqli_fetch_array($query)){
                                        ?>
                                    <form action="../actions/produk/act_edit_produk.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <label>ID Produk</label>
                                            <input type="text" class="form-control" name="id_produk" value="<?php echo $data['id_produk']; ?>" readonly>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="nama_kategori" class="form-control">
                                                ...
                                                <?php 
                                                   ...
                                                   while ($data_kategori=mysqli_fetch_array($sql_kategori)) {
                                                    ...
                                                    echo "<option value=".$data['id_kategori']." $select>".$data_kategori['nama_kategori']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Input File Foto Produk</label><br>
                                            <a href="../images/produk/<?php echo $data['foto_produk']; ?>" target="_blank"><img src="../images/produk/<?php echo $data['foto_produk']; ?>" width="auto" height="100px"></a><br>
                                        ...
                                        <div class="form-group">
                                            <label>Diskon (%)</label>
                                            <input type="number" class="form-control" name="diskon" value="<?php echo $data['diskon']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Stok</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summernote" name="detail"><?php echo $data['detail']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Merek</label>
                                            ...
                                            <option disabled selected>-- Pilih Kategori --</option>
                                                <?php 
                                                   ...
                                                   $sql_merek=mysqli_query($koneksi, $query_merek);
                                                   while ($data_merek=mysqli_fetch_array($sql_merek)) {
                                                    if ($data['id_merek']==$data_merek['id_merek']) {
                                                        $select="selected";
                                                    }else{
                                                        $select="";
                                                    }
                                                    echo "<option value=".$data['id_merek']." $select>".$data_merek['nama_merek']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
