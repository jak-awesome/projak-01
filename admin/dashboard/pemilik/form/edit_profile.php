                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edit Profile</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../profile.php" class="btn btn-warning btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-left"></i>
                                        </span>
                                        <span class="text">Kembali</span>
                                    </a>
                                    <a href="#" class="btn btn-danger btn-icon-split float-right" data-toggle="modal" data-target="#passwordModal">
                                        <span class="icon text-white-50">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            $query = mysqli_query($koneksi, "SELECT * FROM akun WHERE id_akun = '$_SESSION[id_akun]'");
                                            while($data = mysqli_fetch_array($query)){
                                        ?>
                                    <form action="../actions/profil/act_edit_profil.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xl-1 col-md-6 mb-2">

                                        </div>
                                    <div class="col-xl-4 col-md-6 mb-2">
                                    <img src="../img/profile/<?php echo $data['foto']; ?>" width="300px" height="300px" style="object-fit: cover;"><br>
                                        <input type="checkbox" name="ubah_gambar" class="form_control" value="true"> Ceklis jika ingin mengubah gambar
                                    </div>
                                    <div class="col-xl-6 col-md-6 mb-2">
                                    <div class="form-group">
                                        <label>Username</label>
                                            <input type="hidden" class="form-control" name="id_akun" value="<?php echo $data['id_akun']; ?>">
    ...
    <div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php
                    $query_1 = mysqli_query($koneksi, "SELECT * FROM akun WHERE id_akun = '$_SESSION[id_akun]'");
                    while($data_1 = mysqli_fetch_array($query_1)){
                ?>
                <div class="modal-body">
                <form action="../actions/profil/change_password.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Password</label>
                        <input type="hidden" class="form-control" name="id_akun1" value="<?php echo $data_1['id_akun']; ?>">
                ...
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <button type="submit" name="passwordsubmit" class="btn btn-success">Send</button>
                </div>
                </form>
