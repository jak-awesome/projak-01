...
<head>
    ...
    <title>Edit Data Ongkos Kirim</title>
...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Ongkos Kirim</h1>

                        <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                    <a href="../data_ongkir.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                    <form action="../actions/ongkir/act_edit_ongkir.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Kota</label>
                                                <input type="hidden" name="id_ongkir" value="<?php echo $data['id_ongkir']; ?>" class="form-control">
                                                <input type="text" name="kota" value="<?php echo $data['kota']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Biaya</label>
    ...
    <?php if(@$_SESSION['gagal_edit_ongkir']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_edit_ongkir']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_edit_ongkir']); } ?>
