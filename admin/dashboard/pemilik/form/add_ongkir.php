...
<head>
    ...
    <title>Tambah Data Ongkos Kirim</title>
...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Ongkos Kirim</h1>
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                    <form action="../actions/ongkir/act_add_ongkir.php" method="post" enctype="multipart/form-data">
