...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                for ($i=0;$i<count($_POST['nama_objek']);$i++){
                    $n_obj = $_POST['nama_objek'];
                    $data = explode(",",$n_obj[$i]);
                    for ($j=0;$j<count($data);$j++){
                        $n_objek[$i][$j] = $data[$j];
                    }
              }

                for ($i=0;$i<count($_POST['objek1']);$i++){
                    $obj1 = $_POST['objek1'];
                    $data = explode(",",$obj1[$i]);
                    for ($j=0;$j<count($data);$j++){
                        $objek1[$i][$j] = $data[$j];
                ...
                for ($i=0;$i<count($_POST['objek2']);$i++){
                    $obj2 = $_POST['objek2'];
                    $data = explode(",",$obj2[$i]);
                    for ($j=0;$j<count($data);$j++){
                        $objek2[$i][$j] = $data[$j];
                ...
                for ($i=0;$i<count($_POST['objek3']);$i++){
                    $obj3 = $_POST['objek3'];
                    $data = explode(",",$obj3[$i]);
                    for ($j=0;$j<count($data);$j++){
                        $objek3[$i][$j] = $data[$j];
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php
                                        $clustering = new ClusteringKMean($n_objek, $objek1, $objek2, $objek3, $objek, $centroid);
