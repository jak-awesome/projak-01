    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Pembayaran Belum Diverifikasi
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Menunggu Konfirmasi' ORDER BY tanggal_pesan DESC");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/detail_pembayaran.php?id=<?php echo $d['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Pembayaran Telah Diverifikasi
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data1 = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Dikemas' ORDER BY tanggal_pesan DESC");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-primary"><?= $d1['status']; ?></span></td>
                                            <td><?= $d1['total']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/detail_pembayaran.php?id=<?php echo $d1['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
