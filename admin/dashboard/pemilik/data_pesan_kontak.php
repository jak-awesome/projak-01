...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Pesan Masuk
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from pesan_kontak");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="actions/pesan_kontak/act_del_pesan_kontak.php?id=<?php echo $d['id_pesan_kontak']; ?>" class="btn btn-danger btn-circle btn-sm" title="Delete"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
    ...
    <?php if(@$_SESSION['berhasil_hapus_pesan']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_hapus_pesan']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_hapus_pesan']); } ?>

    <?php if(@$_SESSION['gagal_hapus_pesan']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_hapus_pesan']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_hapus_pesan']); } ?>
