...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Pengajuan Pengembalian
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN pengembalian ON pengembalian.id_pesanan=pesanan.id_pesanan WHERE status='Pengembalian' AND status_pengembalian='Tahap Pengajuan' ORDER BY tanggal_pesan DESC");
                                        while($d = mysqli_fetch_array($data)){
			                         ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>INV-AC-<?php echo $d['id_pesanan']; ?></td>
                                            <td><?= $d['tanggal_pesan']; ?></td>
                                            <td><?= $d['nama_lengkap']; ?></td>
                                            <td><span class="badge badge-info"><?= $d['status_pengembalian']; ?></span></td>
                                            <td><?= $d['total']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/detail_pengembalian.php?id=<?php echo $d['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Pengembalian Telah Dikonfirmasi
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data1 = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN pengembalian ON pengembalian.id_pesanan=pesanan.id_pesanan WHERE status='Pengembalian' AND status_pengembalian='Pengembalian Dikonfirmasi' ORDER BY tanggal_pesan DESC");
                                        while($d1 = mysqli_fetch_array($data1)){
			                         ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>INV-AC-<?php echo $d1['id_pesanan']; ?></td>
                                            <td><?= $d1['tanggal_pesan']; ?></td>
                                            <td><?= $d1['nama_lengkap']; ?></td>
                                            <td><span class="badge badge-primary"><?= $d1['status_pengembalian']; ?></span></td>
                                            <td><?= $d1['total']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/detail_pengembalian.php?id=<?php echo $d1['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Barang Return dalam Proses Pengiriman
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data2 = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN pengembalian ON pengembalian.id_pesanan=pesanan.id_pesanan WHERE status='Pengembalian' AND status_pengembalian='Dikirim' ORDER BY tanggal_pesan DESC");
                                        while($d2 = mysqli_fetch_array($data2)){
			                         ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>INV-AC-<?php echo $d2['id_pesanan']; ?></td>
                                            <td><?= $d2['tanggal_pesan']; ?></td>
                                            <td><?= $d2['nama_lengkap']; ?></td>
                                            <td><span class="badge badge-warning"><?= $d2['status_pengembalian']; ?></span></td>
                                            <td><?= $d2['ekspedisi']; ?></td>
                                            <td><?= $d2['resi']; ?></td>
                                            <td><?= $d2['rekening']; ?></td>
                                            <td><?= $d2['total']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/detail_pengembalian.php?id=<?php echo $d2['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Proses Pengembalian yang Selesai
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data3 = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN pengembalian ON pengembalian.id_pesanan=pesanan.id_pesanan WHERE status='Pengembalian' AND status_pengembalian='Pengembalian Selesai' ORDER BY tanggal_pesan DESC");
                                        while($d3 = mysqli_fetch_array($data3)){
			                         ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td>INV-AC-<?php echo $d3['id_pesanan']; ?></td>
                                            <td><?= $d3['tanggal_pesan']; ?></td>
                                            <td><?= $d3['nama_lengkap']; ?></td>
                                            <td><span class="badge badge-success"><?= $d3['status_pengembalian']; ?></span></td>
                                            <td><?= $d3['ekspedisi']; ?></td>
                                            <td><?= $d3['resi']; ?></td>
                                            <td><?= $d3['rekening']; ?></td>
                                            <td><?= $d3['total']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/detail_pengembalian.php?id=<?php echo $d3['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
    ...
    <?php if(@$_SESSION['berhasil_tambah_merek']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_tambah_merek']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_tambah_merek']); } ?>

    <?php if(@$_SESSION['berhasil_hapus_merek']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_hapus_merek']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_hapus_merek']); } ?>

    <?php if(@$_SESSION['gagal_hapus_merek']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_hapus_merek']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_hapus_merek']); } ?>

    <?php if(@$_SESSION['berhasil_edit_merek']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_edit_merek']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_edit_merek']); } ?>
</body>
