...
//     $reportQuery = "SELECT * FROM pesanan
//                     INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan INNER JOIN pembayaran ON pesanan.id_pesanan = pembayaran.id_pembayaran
//                     WHERE status='$status' AND tanggal_pesan BETWEEN '$fromDate' AND '$toDate'";
//     $reportResult = $koneksi->query($reportQuery);
// }
    ...
    <!-- End of Topbar -->
                ...
                <div class="row">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Laporan Penjualan E-Commerce
                        </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="cetak.php" target="_blank">
                                ...
                                <button type="submit" name="cetak" class="btn btn-success">Generate Report</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Laporan Penjualan Toko Offline
                        </div>

                        <div class="card-body">
                            <form method="post" action="cetak_toko.php" target="_blank">
                                <div class="card-body">
                                <div class="form-group">
                                    <label for="fromDate">From Date:</label>
                                    <input type="date" id="fromDate" name="fromDate" class="form-control" required>
