                                ...
                                <table class="table table-bordered table-hover" id="dataTable" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr <?= $notif; ?>>
                                            ...
                                            <td><a href="../karyawan/images/produk/<?php echo $d['foto_produk']; ?>" target="_blank"><img src="../karyawan/images/produk/<?php echo $d['foto_produk']; ?>" width="auto" height="100px"></a></td>
