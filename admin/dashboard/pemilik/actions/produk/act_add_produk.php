    ...
    if(isset($_POST['addsubmit'])){
        ...
        if(in_array($ekstensi, $allowed_extension) == true){
            if($ukuran < 2097152){
                ...
                $query = mysqli_query($koneksi, "INSERT INTO produk (id_produk, nama_produk, foto_produk, harga, diskon, stok, detail, id_merek, id_kategori, harga_jual) VALUES('$id_produk', '$nama_produk', '$gambar', '$harga', '$diskon', '$stok', '$detail', '$nama_merek', '$nama_kategori', '$harga_jual')");
