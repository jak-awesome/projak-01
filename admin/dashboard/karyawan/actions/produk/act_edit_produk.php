...
if(isset($_POST['ubah_gambar'])){
        ...
        if(in_array($ekstensi, $allowed_extension) == true){
            if($ukuran < 2097152){
                ...
                $query = mysqli_query($koneksi, "UPDATE produk SET nama_produk='$nama_produk', foto_produk='$gambar', harga='$harga', diskon='$diskon', detail='$detail', id_kategori='$nama_kategori', id_merek='$nama_merek', harga_jual='$harga_jual' WHERE id_produk='$id_produk'");
    ...
    $query = mysqli_query($koneksi, "UPDATE produk SET nama_produk='$nama_produk', harga='$harga', diskon='$diskon', detail='$detail', id_kategori='$nama_kategori', id_merek='$nama_merek', harga_jual='$harga_jual' WHERE id_produk='$id_produk'");
