...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Ongkos Kirim</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        <a href="form/add_ongkir.php" class="btn btn-success btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-file"></i>
                                        </span>
                                        <span class="text"> Tambah Data Ongkos Kirim</span>
                                    </a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "Rp. ".number_format($d['biaya'])." ,-" ?></td>
                                        <td width="10%" align="center">
                                        <a href="form/edit_ongkir.php?id=<?php echo $d['id_ongkir']; ?>" class="btn btn-info btn-circle btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="actions/ongkir/act_del_ongkir.php?id=<?php echo $d['id_ongkir']; ?>" class="btn btn-danger btn-circle btn-sm alert_notif" title="Delete"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                        <?php 
                                            }
    ...
    <?php if(@$_SESSION['berhasil_tambah_ongkir']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_tambah_ongkir']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_tambah_ongkir']); } ?>

    <?php if(@$_SESSION['berhasil_hapus_ongkir']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_hapus_ongkir']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_hapus_ongkir']); } ?>

    <?php if(@$_SESSION['gagal_hapus_ongkir']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_hapus_ongkir']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_hapus_ongkir']); } ?>

    <?php if(@$_SESSION['berhasil_edit_ongkir']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_edit_ongkir']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_edit_ongkir']); } ?>
