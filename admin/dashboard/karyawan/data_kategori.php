    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="form/add_kategori.php" class="btn btn-success btn-icon-split">
                                    ...
                                    <?php 
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/edit_kategori.php?id=<?php echo $d['id_kategori']; ?>" class="btn btn-info btn-circle btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="actions/kategori/act_del_kategori.php?id=<?php echo $d['id_kategori']; ?>" class="btn btn-danger btn-circle btn-sm alert_notif" title="Delete"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
