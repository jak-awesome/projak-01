    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="form/add_produk.php" class="btn btn-success btn-icon-split">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" cellspacing="0">
                                    <thead>
                                        ...
                                        <?php 
                                            include '../../../koneksi.php';
                                            $no = 1;
                                            $data = mysqli_query($koneksi,"SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori INNER JOIN merek ON produk.id_merek=merek.id_merek");
                                            while($d = mysqli_fetch_array($data)){
                                                if($d['stok_akhir'] == "0"){
                                                    $notif = "style='background-color: #FFC2B4;'";
                                                } else {
                                                    $notif = "";
                                                }
                                        ?>
                                        <tr <?= $notif; ?>>
                                            ...
                                            <td><a href="images/produk/<?php echo $d['foto_produk']; ?>" target="_blank"><img src="images/produk/<?php echo $d['foto_produk']; ?>" width="auto" height="100px"></a></td>
                                            <td><?php echo "Rp. ".number_format($d['harga'])." ,-" ?></td>
                                            <td><?php echo $d['diskon']; ?></td>
                                            <td><?php echo "Rp. ".number_format($d['harga_jual'])." ,-" ?></td>
                                            <td><?php echo $d['stok_awal']; ?></td>
                                            <td><?php echo $d['stok_akhir']; ?></td>
                                            <td><?php echo $d['nama_merek']; ?></td>
                                            <td width="10%" align="center">
                                            <a href="form/view_detail.php?id=<?php echo $d['id_produk']; ?>" class="btn btn-warning btn-circle btn-sm" title="View Description of Product"><i class="fas fa-eye"></i></a>
                                            <a href="form/edit_produk.php?id=<?php echo $d['id_produk']; ?>" class="btn btn-info btn-circle btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="actions/produk/act_del_produk.php?id=<?php echo $d['id_produk']; ?>" class="btn btn-danger btn-circle btn-sm alert_notif" title="Delete"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php 
		                                    }
