...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="form/add_merek.php" class="btn btn-success btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-file"></i>
                                        </span>
                                        <span class="text"> Tambah Data Merek</span>
                                    </a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"select * from merek");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/edit_merek.php?id=<?php echo $d['id_merek']; ?>" class="btn btn-info btn-circle btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="actions/merek/act_del_merek.php?id=<?php echo $d['id_merek']; ?>" class="btn btn-danger btn-circle btn-sm alert_notif" title="Delete"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
    ...
    <?php if(@$_SESSION['warning_hapus_merek']){ ?>
        <script>
            swal.fire("Peringatan!", "<?php echo $_SESSION['warning_hapus_merek']; ?>", "warning");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['warning_hapus_merek']); } ?>
