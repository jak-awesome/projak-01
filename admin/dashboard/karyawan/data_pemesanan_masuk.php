                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Belum Dibayar' ORDER BY tanggal_pesan DESC");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/detail_pesanan.php?id=<?php echo $d['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="View Detail"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Pengembalian' ORDER BY tanggal_pesan DESC");
                                        while($d = mysqli_fetch_array($data)){
			                         ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
