    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="form/add_faq.php" class="btn btn-success btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-file"></i>
                                        </span>
                                        <span class="text"> Tambah Data FAQ</span>
                                    </a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php 
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/edit_faq.php?id=<?php echo $d['id_faq']; ?>" class="btn btn-info btn-circle btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="actions/faq/act_del_faq.php?id=<?php echo $d['id_faq']; ?>" class="btn btn-danger btn-circle btn-sm alert_notif" title="Delete"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
