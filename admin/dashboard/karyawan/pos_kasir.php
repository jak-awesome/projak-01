...
<div id="content">
                        ...
                        <div class="col-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Cari Barang</h6>
                                </div>
                                <div class="card-body">
                                    <form method="get" action="pos_kasir.php">
                                        <div class="input-group mb-3">
                                            <input type="text" id="cari" class="form-control" name="produk" placeholder="Masukkan : Kode/Kategori/Nama Produk">
                                            <div class="input-group-append">
                                                <input type="submit" id="cari" class="btn btn-outline-secondary" name="cari_produk" value="Cari">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    if(isset($_GET['cari_produk'])){
                                        $produk = $_GET['produk'];
                                        $no = 1;
                                        $data_produk = mysqli_query($koneksi, "SELECT * FROM produk INNER JOIN kategori ON produk.id_kategori=kategori.id_kategori INNER JOIN merek ON produk.id_merek=merek.id_merek WHERE nama_produk like '%".$produk."%' OR nama_kategori like '%".$produk."%' AND stok > 0");
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $d['id_produk']; ?></td>
                                                    <td><img src="images/produk/<?php echo $d['foto_produk']; ?>" style="width: auto; height: 100px;"></td>
                                                    <td><?= $d['nama_produk']; ?></td>
                                                    <td><?= $d['stok']; ?></td>
                                                    <td><?= $d['harga_jual']; ?></td>
                                                    <td><a class="btn btn-primary" href="pos_kasir.php?act=beli&&produk_id=<?php echo $d['id_produk']; ?>"><i class="fas fa-fw fa-plus"></i></a></td>
                                                </tr>
                                                <?php
                                                }}
                                                ?>
                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><img src="images/produk/<?= $product['foto_produk']; ?>" style="width: auto; height: 100px;"></td>
                                                    <td><?= $product['nama_produk'] ?></td>
                                                    <td><form action="pos_kasir.php" method="GET"> 
                                                        ...
                                                        <input class="form-control" type="number" name="qty" value="<?php echo $qty; ?>" onchange="this.form.submit()" style="width: 100px;"></form></td>
                                                    <td><?php echo "Rp. ".number_format($t) ?></td>
                                                    <td><a class="btn btn-danger" href="pos_kasir.php?delete_cart=yes&&act=beli&&produk_id=<?php echo $pid; ?>"><i class="fas fa-fw fa-trash"></i></a></td>
                                                </tr>
                                                <?php } } ?>
                                            </tbody>
                                            <tfoot>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="total" value="<?php echo "Rp. ".number_format($total) ?>"> 
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <label>Bayar</label>
                                    ...
                                    <div class="col-4">
                                    <form action="pos_kasir.php" method="get">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="nominal_bayar" value="<?php echo "Rp. ".number_format($nominal_bayar) ?>">
                                        </div>
                                    </div>
                                    <div class="col-2">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="" value="<?php echo "Rp. ".number_format($kembali) ?>">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                    ...
                                    <div class="col-4">
                                        <form action="actions/transaksi_toko/act_add_order.php" method="post" target="_blank">
                                            <input type="hidden" name="nominal_bayar" value="<?= $nominal_bayar; ?>">
                                            <input type="hidden" name="total" value="<?= $total; ?>">
                                            <input type="hidden" name="kembali" value="<?= $kembali; ?>">
                                            <input type="hidden" name="kasir" value="<?= $_SESSION['id_akun']; ?>">
                                            <input type="submit" class="btn btn-secondary" value="Print" name="print" style="width: 100%;">
                                        </form>
                                    </div>
                                    </div>
                                </div>
    ...
    <?php if(@$_SESSION['warning_hapus_kategori']){ ?>
        <script>
            swal.fire("Peringatan", "<?php echo $_SESSION['warning_hapus_kategori']; ?>", "warning");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['warning_hapus_kategori']); } ?>
