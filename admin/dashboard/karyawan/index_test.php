...
<div style="float:left;width:500px;">
	...
	<TABLE width="450px" border="1" cellpadding="0" cellspacing="0" bordercolor="#000066" id="data">
		...
		<tbody>
			<TR>
				<TD> 1 </TD>
				<TD><INPUT type="text" size="50" name="objek[]" value="<?= $data['terjual']; ?>"/></TD>
			</TR>
		</tbody>
		<?php } ?>
	</TABLE>
...
<div style="float:left;width:500px;">
	...
	<TABLE width="450px" border="1" cellpadding="0" cellspacing="0" bordercolor="#000066" id="cluster">
		...
		<tbody>
			<TR>
				<TD> 1 </TD>
				<TD><INPUT type="text" size="50" name="cluster[]" value="25" readonly/></TD>
			</TR>
			<TR>
				<TD> 2 </TD>
				<TD><INPUT type="text" size="50" name="cluster[]" value="75" readonly/></TD>
			</TR>
		</tbody>
	</TABLE>
</div>
