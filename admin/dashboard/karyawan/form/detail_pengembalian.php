                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data" action="../actions/pengembalian/edit_status_pengembalian.php">
                                                ...
                                                <div class="form-group">
                                                    <label>Konfirmasi Pengembalian</label>
                                                    <input type="hidden" name=id_pengembalian value="<?= $d_pengembalian['id_pengembalian']; ?>">
                                                    <select <?= $disabled ?> class="form-control" name="status_pengembalian">
                                                        <option value="Pengembalian Dikonfirmasi">Konfirmasi</option>
                                                        <option value="Pengembalian Ditolak">Tolak</option>
                                                    </select>
                                                </div>
                                                <input <?= $disabled ?> class="btn btn-outline-primary" type="submit" name="ubahStatus" value="Ubah">
                                            </form>
                                        </div>
                                        <?php
                                        if($d_pengembalian['status_pengembalian'] == "Dikirim"){
                                            $info = "<hr>
                                                ...
                                                <div class='col-12'>
                                                    <form action='../actions/pengembalian/finish_return.php' method='post'>
                                                    <input type='hidden' value='$d_pengembalian[id_pengembalian]' name='id_pengembalian'>
                                                    <input type='submit' name='finish_return' value='Selesaikan Pesanan' class='btn btn-success' style='width: 100%;'>
                                                    </form>
                                                </div>    
                                            </div>";
                                        } else {
