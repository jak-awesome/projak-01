...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../data_pengiriman.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <input type="text" placeholder="<?= $data['status']; ?>" class="form-control" readonly>
                                                    </div>
                                                </div>
                                        </div>
                                        <hr>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><?= $no++; ?></td>
                                                                <td><img src="../images/produk/<?= $data2['foto_produk']; ?>" style="width: 100px; height: 100px; object-fit: cover;"></td>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <hr>
                                        <h4>Masukkan Informasi Pengiriman</h4>
                                        <form action="../actions/pengiriman/act_add_pengiriman.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label>Ekspedisi</label>
                                                    <input type="hidden" name="id_pesanan" value="<?= $data['id_pesanan']; ?>">
                                                    <input type="text" class="form-control" name="ekspedisi" placeholder="Masukkan ekspedisi pengiriman. Cth: JNE">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label>Resi</label>
                                                    <input type="text" name="resi" class="form-control" placeholder="Masukkan resi pengiriman">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <input type="submit" class="btn btn-primary" name="submitPengiriman" value="Simpan">
                                            </div>
                                        </div>
                                        </form>
                                        <?php } ?>
    ...
    <?php if(@$_SESSION['gagal_tambah_pengiriman']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_tambah_pengiriman']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_tambah_pengiriman']); } ?>
