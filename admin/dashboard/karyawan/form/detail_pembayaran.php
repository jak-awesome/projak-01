    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../data_pembayaran.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <form method="post" enctype="multipart/form-data" action="../actions/pesanan/edit_status_pesanan.php">
                                                    <?php
                                                    $query4 = mysqli_query($koneksi, "SELECT * FROM pembayaran WHERE id_pesanan='$id'");
                                                    while($data4 = mysqli_fetch_array($query4)){
                                                    ?>
                                                    <a href="../../../../pelanggan/web/market_log/img/pembayaran/<?= $data4['bukti_pembayaran']; ?>" target="__blank"><img src="../../../../pelanggan/web/market_log/img/pembayaran/<?= $data4['bukti_pembayaran']; ?>" style="width: 200px; height: 200px; object-fit: cover;"></a>
                                                    <?php } ?>
                                                <div class="form-group">
                                                    <label>Status Pemesanan</label>
                                                    <input type="hidden" name=id_pesanan value="<?= $id; ?>">
                                                    <select <?= $disabled ?> class="form-control" name="status_pemesanan">
                                                        <option value="Dikemas">Konfirmasi Pesanan</option>
                                                        <option value="Dibatalkan">Batalkan</option>
                                                    </select>
                                                </div>
                                                <input <?= $disabled ?> class="btn btn-success" type="submit" name="ubahStatus" value="Ubah">
                                            </form>
                                        </div>
                                        <?php } ?>
                                    </div>
