...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../data_faq.php" class="btn btn-warning btn-icon-split">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            include "../../../../koneksi.php";
                                            $id = $_GET['id'];
                                            $query = mysqli_query($koneksi, "SELECT * FROM faq WHERE id_faq = '$id'");
                                            while($data = mysqli_fetch_array($query)){
                                        ?>
                                    <form action="../actions/faq/act_edit_faq.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Pertanyaan</label>
                                                <input type="hidden" name="id_faq" value="<?php echo $data['id_faq']; ?>" class="form-control">
                                                <input type="text" name="pertanyaan" value="<?php echo $data['tanya']; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Jawaban</label>
                                            <textarea class="form-control" id="summernote" name="jawaban"><?php echo $data['jawab']; ?></textarea>
                                        </div>
                                    </div>
    ...
    <?php if(@$_SESSION['gagal_edit_kategori']){ ?>
        <script>
            swal.fire("Oh Tidak!", "<?php echo $_SESSION['gagal_edit_kategori']; ?>", "error");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['gagal_edit_kategori']); } ?>
