    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <a href="../data_pesanan.php" class="btn btn-warning btn-icon-split">
                                        ...
                                        <?php
                                            ...
                                            while($data = mysqli_fetch_array($query)){
                                                ...
                                                if($data['status'] != "Menunggu Konfirmasi")
                                                {
                                                    ...
                                                    Untuk melakukan konfirmasi pesanan, silahkan buka menu pembayaran atau bisa klik <a class='alert-link' href='detail_pembayaran.php?id=$data[id_pesanan]'>link ini</a>.
                                                    </div>";
                                                }
