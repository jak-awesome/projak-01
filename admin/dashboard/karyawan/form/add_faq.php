    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                    <form action="../actions/faq/act_add_faq.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Jawaban</label>
                                            <textarea class="form-control" id="summernote" name="jawaban" required></textarea>
                                        </div>
                                    </div>
