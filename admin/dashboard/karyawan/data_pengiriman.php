...
<div id="content">
    ...
    <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Siap Dikirim
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Dikemas' ORDER BY tanggal_pesan DESC");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <a href="form/detail_pengiriman.php?id=<?php echo $d['id_pesanan']; ?>" class="btn btn-warning btn-circle btn-sm" title="Edit"><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
		                                }
                    ...
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">Proses Pengiriman
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                        include '../../../koneksi.php';
                                        $no = 1;
                                        $data1 = mysqli_query($koneksi,"SELECT * FROM pengiriman INNER JOIN pesanan ON pengiriman.id_pesanan=pesanan.id_pesanan INNER JOIN pelanggan ON pesanan.id_pelanggan=pelanggan.id_pelanggan WHERE status='Dikirim' ORDER BY tanggal_pesan DESC");
			                         ...
			                         ?>
                                        <tr>
                                            ...
                                            <td><?= $d1['ekspedisi']; ?></td>
                                            <td><?= $d1['resi']; ?></td>
                                            <td><?= $d1['tgl_pengiriman']; ?></td>
                                            <td><?= $d1['waktu_pengiriman']; ?></td>
                                            <td><span class="badge badge-warning"><?= $d1['status']; ?></span></td>
                                        </tr>
                                    <?php 
		                                }
		                            ?>
    ...
    <?php if(@$_SESSION['berhasil_tambah_pengiriman']){ ?>
        <script>
            swal.fire("Selamat!", "<?php echo $_SESSION['berhasil_tambah_pengiriman']; ?>", "success");
        </script>
    <!-- jangan lupa untuk menambahkan unset agar sweet alert tidak muncul lagi saat di refresh -->
    <?php unset($_SESSION['berhasil_tambah_pengiriman']); } ?>
